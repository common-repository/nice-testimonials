...
/**
 * Class Nice_Testimonials_CreateActionAbstract
 *
 ...
 * @since   1.0
 */
abstract class Nice_Testimonials_CreateActionAbstract extends Nice_Testimonials_ActionAbstract {
	/**
	...
	public function __invoke( array $data ) {
		...
		if ( $instance instanceof Nice_Testimonials_EntityInterface ) {
